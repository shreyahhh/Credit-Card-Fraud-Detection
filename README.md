 The project uses various data analytics techniques for credit card fraud detection, including outlier detection, scaling, feature engineering, model training, and evaluation.
1. OUTLIER DETECTION :
